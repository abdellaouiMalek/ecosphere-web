 ...
 */
final class Version20240305162424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carpooling DROP passenger_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carpooling ADD passenger_id VARCHAR(255) DEFAULT NULL');
    }
}
