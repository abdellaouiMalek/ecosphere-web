 ...
 */
final class Version20240304103317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD category_id INT DEFAULT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD category VARCHAR(255) DEFAULT NULL, DROP category_id');
    }
}
